...
| `realistic-story-breakdown.schema.json` | Isolated realistic-v4 Story Breakdown candidate | Future realistic final validator/exporter |
...
Run `python3 scripts/validate_realistic_v4_story_breakdown.py` for the isolated PRD-execution-9725 story hierarchy, lineage, provenance, coverage, negative mutations, and unpublished n8n export.
