...
| Uneven estimation readiness | Review each story, infer relative effort, and separately flag refinement needs | Post-story Sizing proposes T-shirt size, confidence, rationale, and refinement guidance | Approved stories, criteria, dependencies, NFRs → S/M/L/XL proposals and refinement list | AI estimate treated as commitment → advisory, non-blocking output with confidence disclosure and required team review |
