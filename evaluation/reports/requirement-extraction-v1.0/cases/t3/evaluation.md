...
| All required item types are present. | Pass | Required: ['functional_requirement', 'non_functional_requirement']; actual: ['acceptance_criterion', 'functional_requirement', 'non_functional_requirement'] |
...
| Additional actual items require semantic review. | Pass | Additional item IDs: ['AC-001'] |

Deterministic evaluation generated 2026-08-03T22:26:25.142235+00:00. Token, cost, or latency values remain zero when they were not supplied to this local evaluator.
