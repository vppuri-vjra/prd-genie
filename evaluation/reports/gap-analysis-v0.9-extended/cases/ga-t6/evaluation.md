# GA-T6 Gap Analysis Evaluation

- Result: **fail**
- Run ID: `RUN-T6-GROUND-TRUTH`
- Groundedness: **84.62%**
- Supported claims: 11/13
- Langfuse trace: `139eedec8897a7244f805c20d3467794`
...
| All approved gaps are present. | Fail | Missing gap keys: [(('MISS-002',), 'deadline')] |
