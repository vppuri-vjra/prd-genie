...
| `gap-analyzer-v0.9.md` | Current candidate; preserves explicit dependency uncertainty as a source-linked risk and proceed-with-TBD gap | `schemas/gap-analysis.schema.json` |
