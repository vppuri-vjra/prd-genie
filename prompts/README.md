...
| `requirement-extractor-v1.5.md` | Targeted candidate; distinguishes product fragments from content with no requirements | `schemas/requirement-extraction.schema.json` |
